        ...
        <div>
            <section className="dark:bg-gray-100 dark:text-gray-800">
                <div className="container flex flex-col justify-center px-4 py-8 mx-auto md:p-8">
                    <h2 className="text-2xl text-center text-bold text-blue-900 font-semibold sm:text-4xl">Frequently Asked Questions</h2>
                    ...
                    <div className="space-y-4">
                        ...
                        {[
                            ...
                            <details key={index} className="w-full border rounded-lg group transition-all">
                                ...
                                <p className="px-4 py-4 pt-0 ml-4 -mt-2 text-gray-600 text-base leading-relaxed">
                                    {faq.answer}
                                </p>
                            </details>
                        ))}
