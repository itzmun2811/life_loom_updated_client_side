...
const PopularPolicy = () => {
  ...
  return (
    <section className="w-11/12 mx-auto px-4 py-12 mt-12 ">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
        {data.map((policy, index) => (
          <div
            ...
            className="bg-[#dce6e8b7] border p-4 border-gray-200 dark:border-gray-700 rounded-xl shadow-md hover:shadow-xl transition duration-300"
          >
