            ...
            <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
                ...
                <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
                    ...
                    <div className="space-y-3">
                        <h3 className="tracking-wide uppercase dark:text-gray-900"> Policies</h3>
                        <ul className="space-y-1">
                            <li>
                                <a rel="noopener noreferrer" href="#">Term Life Insurance</a>
                            </li>
                            <li>
                                <a rel="noopener noreferrer" href="#">Whole Life Coverage</a>
                            </li>
                            <li>
                                <a rel="noopener noreferrer" href="#">Critical Illness Plan</a>
                            </li>
                            <li>
                                <a rel="noopener noreferrer" href="#">Family Protection</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    {/* Help & Support */}
                    <div className="space-y-3">
                        <h3 className="uppercase dark:text-gray-900">Help & Support</h3>
                        <ul className="space-y-1">
                            <li>
                                <a rel="noopener noreferrer" href="#">Claims Center</a>
                            </li>
                            <li>
                                <a rel="noopener noreferrer" href="#">Support Docs</a>
                            </li>
                            <li>
